class Quizzes::QuestionsController < ApplicationController
  ...
  def quizzes_question_params
    params.require(:quizzes_question).permit(:quiz_id, :topic, :ordinal, :question, :open_ended, :answer, :answer_option_id, :answer_template, options_attributes: [:id, :label, :grade, :_destroy])
  end
end
