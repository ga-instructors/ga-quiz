...
ActiveRecord::Schema.define(version: 20151012002028) do
  ...
  add_index "quizzes_answers", ["assessment_id", "question_id"], name: "index_quizzes_answers_on_assessment_id_and_question_id", unique: true, using: :btree
